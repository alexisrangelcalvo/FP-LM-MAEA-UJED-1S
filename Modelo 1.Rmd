...
Train_1 = read.csv("muestra_completa.csv")
...
Dado que las pruebas con MSPR y accuracy por matriz de confusión fueron tecnicamente similares, decidimos optar por quedarnos con el modelo con 7 features porque es un modelo con menos variables.  

##### Exportando modelo al directorio

```{r}
save(modelo_1_2, cfmx2, file = "Modelo_1.RData")
```
