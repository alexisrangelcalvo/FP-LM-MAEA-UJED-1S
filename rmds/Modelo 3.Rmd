...
- Si la variable `Months.since.last.delinquent` aumenta en 100 unidades, este evento estara asociado con un aumento del 1.1% en las probabilidades del pago al corriente (`Fully Paid`).
...
```{r}
save(modelo_1_3, cfmx2, file = "../models/Modelo_3.RData")
```
